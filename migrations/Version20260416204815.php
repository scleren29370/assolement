 ...
 */
final class Version20260416204815 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assolement ADD date_semis DATE NOT NULL, ADD date_recolte DATE DEFAULT NULL, DROP surface');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE assolement ADD surface DOUBLE PRECISION NOT NULL, DROP date_semis, DROP date_recolte');
